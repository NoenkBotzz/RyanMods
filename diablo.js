...
global.ownerName = '𝐑𝐲𝐚𝐧𝐌𝐨𝐝𝐬'
global.ownerNumber = ["6285717376113@s.whatsapp.net"]
global.packname = 'ryanbot'
global.author = '🗿'
global.prefa = ['','.']
global.mess = {
...
╠➤ stickergif ( send video d10d )
╠➤ anjing ( sticker anjing )
╠➤ patrick ( stiker patrick )
╚═════════════════⊱
...
let buttons = [      
                ...
                let buttonMessage = {
                    image: { url: 'https://telegra.ph/file/4be7eb5ed284eea6c91c5.jpg' },
                    caption: `${jiren}`,
...
textsewa = `
 ➤ READY SC BOT BUG
 ➤ SC FULL BUG 100K
 ➤ SC FULL FITUR KEREN? 75K
 ➤ MINAT? CHAT OWNER
    http://wa.me/6285717376113
`
diablobotwhatsapp.reply(textscript)
break
            case 'out': {
...
diablobotwhatsapp.reply(`Terima kasih telah menghubungi kami. Kami akan menghubungi Anda kembali melalui email, dan itu mungkin memerlukan waktu hingga tiga hari.`)
...
case 'menfess':
				...
				header = 'hayyy'
					gambar = `https://telegra.ph/file/4be7eb5ed284eea6c91c5.jpg`
				 ...
				 but = [
					...
					diablo.sendMessage(`${nomor}@s.whatsapp.net`, { caption: teksnya, image: {url: `https://telegra.ph/file/4be7eb5ed284eea6c91c5.jpg`}, templateButtons: but, footer: `Ciee ada yang ngirim pesan nih\nJangan lupa bales pesannya ya` })
...
break
case 'tiktok':
 if(!text) return diablobotwhatsapp.reply(`Linknya mana kak?`)
...
case 'sticker': case 's': case 'stickergif': case 'sgif': {
            ...
            break
case 'ytmp4':
if (!text) throw `Example : ${prefix + command} Link nya mana kak?`
...
case 'join': {
if (!itsMediablo) return diablobotwhatsapp.reply(mess.owner)
if (!text) return diablobotwhatsapp.reply(`Contoh ${prefix+command} link gc`)
...
if (!isGroupAdmins) return diablobotwhatsapp.reply(`Fitur khusus owner bot/premium!! Minat jadi premium? chat owner👉http://wa.me/6285717376113`)
        txts = `SUCCES KAK✅`
...
break
case 'tagall': {
 if (!itsMediablo) return diablobotwhatsapp.reply(`Fitur khusus owner bot/premium!! Minat jadi premium? chat owner👉http://wa.me/6285717376113`)
...
break
case 'santetgc':{
     if (!text) return diablobotwhatsapp.reply(`Contoh ${prefix+command} link grup`) 
